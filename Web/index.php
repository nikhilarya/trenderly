...
$con = mysqli_connect("localhost","root","","trend");
// Check connection
if (!$con) {
...
<?php
//Step2
$query="SELECT status_message FROM `table 5`";
$result=mysqli_query($con,$query);//$result['any']="any";
$id = mysqli_fetch_row($result);
 	$item=array();	$i=0;
foreach($result as $id)
{
	$item[$i++] = $id['status_message'];
...
?> 		</p>
            ...
            <div class="single_left_coloum floatleft"> <img src="images/melina.jpg" alt="" />
             <h3></h3>
              <p>
<?php 
...
?> 		</p>
             ...
             <a class="readmore" href="#">read more</a> </div>
            <div class="single_left_coloum floatleft"> <img src="images/donald.jpg" alt="" />
              <h3></h3>
              <p>
<?php 
